                            ...
                            <td class="py-2 px-4">
                                ...
                                @if ($canDelete)
                                    <button class="bg-red-600 text-white px-3 py-1 rounded hover:bg-red-700 transition"
                                        onclick="openModal({{ $user->id }}, '{{ $user->name }}', 'Admin')">
                                        {{ __('button.delete') }}
                                    </button>
                                @else
    ...
    <div id="deleteModal" class="hidden fixed inset-0 flex items-center justify-center z-50">
        <div class="bg-white p-6 rounded-lg shadow-2xl max-w-sm w-full">
            ...
            <div class="flex justify-end space-x-3">
                <button onclick="closeModal()" class="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400 transition">
                    {{ __('button.cancel') }}
                </button>
        ...
        <div class="bg-white p-6 rounded-lg shadow-2xl w-full max-w-md">
            ...
            <form method="POST" action="{{ route('admin.users.store') }}" id="addAdminForm">
                ...
                <div class="flex justify-end space-x-3 mt-6">
                    ...
                    <button type="submit" class="px-4 py-2 bg-slate-800 text-white rounded hover:bg-slate-900 transition">
                        {{ __('button.add') }}
                    </button>
                </div>
            </form>
