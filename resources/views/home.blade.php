    ...
    @else
        <div class="relative bg-white border rounded p-6 shadow text-center overflow-visible">
            ...
            <div class="blur-sm select-none pointer-events-none">
                <h2 class="text-lg font-semibold opacity-70">
                    {{ __('current_favorites') }}
                </h2>
                ...
                <div class="relative group">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round"
                              d="M16.5 10.5V7.125a4.125 4.125 0 1 0-8.25 0V10.5
                                 m-2.25 0h12.75
                                 M6.75 10.5a2.25 2.25 0 0 0-2.25 2.25v6.75
                                 A2.25 2.25 0 0 0 6.75 21.75h10.5
                                 a2.25 2.25 0 0 0 2.25-2.25v-6.75
